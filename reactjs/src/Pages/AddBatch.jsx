...
export default function AddBatch() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // await axiosInstance.post("/admin/batch", payload);
    ...
    <>
      ...
      <div className="w-100 min-vh-100 p-4">
        <div className="d-flex align-items-center justify-content-center">
          ...
          <div className="card shadow border-0 p-5" style={{ maxWidth: "700px", width: "100%" }}>

            <h2 className="fw-bold text-center mb-4">Add New Batch</h2>

            <p className="text-muted text-center mb-4">
              Create a new batch by selecting academic years and department.
            </p>
